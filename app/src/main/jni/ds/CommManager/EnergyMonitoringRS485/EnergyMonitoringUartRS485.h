...
#ifndef __ENERGYMONITORINGUARTRS485_H__
#define __ENERGYMONITORINGUARTRS485_H__
...
class EnergyMonitoringUartRS485 :  public CommManager {	
	 ...
	 private: // Private attributes
			  ...
			  /** identify that company of device interface type */
	  ...
	  public:		  	 
			  ...
			  /** default constructor */
			  EnergyMonitoringUartRS485();

			  /** default destructor */
			  virtual ~EnergyMonitoringUartRS485();
