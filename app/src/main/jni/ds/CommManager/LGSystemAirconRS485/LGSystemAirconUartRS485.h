...
#ifndef __LGSYSTEMAIRCONUARTRS485_H__
#define __LGSYSTEMAIRCONUARTRS485_H__
...
class LGSystemAirconUartRS485 :  public CommManager {	
	 ...
	 private: // Private attributes
			  ...
			  /** identify that company of device interface type : �ڸƽ�, �浿 , ���Ͽ� */
			  enum UARTINTERFACECOMPANY mediaInterfaceType;
			
			  /** identify that The company using of device interface protocol : �ڸƽ� RS485��������, �浿 RS485��������, ���Ͽ�*/
			 enum UARTINTERFACEPROTOCOL mediaInterfaceProtocol;
	  public:		  	 

			  /** default constructor */
			  LGSystemAirconUartRS485 ();

			  /** default destructor */
			  virtual ~LGSystemAirconUartRS485 ();
			 ...
			 // Thread Atrribute
			 pthread_t LGSystemAirconRs485_thread;

			 pthread_attr_t LGSystemAirconRs485_thread_t;
