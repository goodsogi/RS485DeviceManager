...
/******************************************************
  NAME     : SmartDoorPhoneUartRS485.H
  Coded by : �� ����
  Revision : 1.0
  Date     : 2013/04/30 ~
...
#ifndef __TECHNOSMARTDOORPHONEUARTRS485_H__
#define __TECHNOSMARTDOORPHONEUARTRS485_H__
...
class TechnoSmartDoorPhoneUartRS485 :  public CommManager {	
	 ...
	 private: // Private attributes
	  ...
	  public:		  	 
			  ...
			  /** default constructor */
			  TechnoSmartDoorPhoneUartRS485();

			  /** default destructor */
			  virtual ~TechnoSmartDoorPhoneUartRS485();
