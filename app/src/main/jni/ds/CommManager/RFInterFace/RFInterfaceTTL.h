...
#ifndef __RFINTERFACETTL_H__
#define __RFINTERFACETTL_H__
...
class RFInterfaceTTL :  public CommManager {	
	...
	public:
			  ...
			  /** default destructor */
			  //virtual ~RFInterfaceTTL() {	UartClose(); };
	
			  /** default constructor */
			  RFInterfaceTTL();

			  /** default destructor */
			  virtual ~RFInterfaceTTL();
			 ...
			 // Thread Atrribute
			 pthread_t rf_ttl_thread;

			 pthread_attr_t rf_ttl_thread_t;
